...
import static shop.abcommerce.domain.CategoryAsserts.*;
...
import shop.abcommerce.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    public static Category createEntity() {
        return new Category().categoryName(DEFAULT_CATEGORY_NAME).description(DEFAULT_DESCRIPTION).state(DEFAULT_STATE);
    }
    ...
    public static Category createUpdatedEntity() {
        return new Category().categoryName(UPDATED_CATEGORY_NAME).description(UPDATED_DESCRIPTION).state(UPDATED_STATE);
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.categoryName(UPDATED_CATEGORY_NAME).description(UPDATED_DESCRIPTION).state(UPDATED_STATE);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.categoryName(UPDATED_CATEGORY_NAME).state(UPDATED_STATE);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.categoryName(UPDATED_CATEGORY_NAME).description(UPDATED_DESCRIPTION).state(UPDATED_STATE);
