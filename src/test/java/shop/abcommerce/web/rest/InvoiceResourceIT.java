...
import static shop.abcommerce.domain.InvoiceAsserts.*;
...
class InvoiceResourceIT {
    ...
    private static final String DEFAULT_PREF = "AAAAAAAAAA";
    private static final String UPDATED_PREF = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_REF_TRANSACTION = "AAAAAAAAAA";
    private static final String UPDATED_REF_TRANSACTION = "BBBBBBBBBB";
    ...
    public static Invoice createEntity() {
        Invoice invoice = new Invoice()
            ...
            .refTransaction(DEFAULT_REF_TRANSACTION)
            .state(DEFAULT_STATE);
        // Add required entity
        Order order;
    ...
    public static Invoice createUpdatedEntity() {
        Invoice updatedInvoice = new Invoice()
            ...
            .refTransaction(UPDATED_REF_TRANSACTION)
            .state(UPDATED_STATE);
        // Add required entity
        Order order;
    ...
    void getAllInvoices() throws Exception {
        ...
        insertedInvoice = invoiceRepository.save(invoice);
        ...
        restInvoiceMockMvc
            ...
            .andExpect(jsonPath("$.[*].pref").value(hasItem(DEFAULT_PREF)))
            .andExpect(jsonPath("$.[*].invoiceNumber").value(hasItem(DEFAULT_INVOICE_NUMBER)))
            .andExpect(jsonPath("$.[*].paymentStatus").value(hasItem(DEFAULT_PAYMENT_STATUS.toString())))
            .andExpect(jsonPath("$.[*].refTransaction").value(hasItem(DEFAULT_REF_TRANSACTION)))
    ...
    void getInvoice() throws Exception {
        ...
        restInvoiceMockMvc
            ...
            .andExpect(jsonPath("$.pref").value(DEFAULT_PREF))
            .andExpect(jsonPath("$.invoiceNumber").value(DEFAULT_INVOICE_NUMBER))
            .andExpect(jsonPath("$.paymentStatus").value(DEFAULT_PAYMENT_STATUS.toString()))
            .andExpect(jsonPath("$.refTransaction").value(DEFAULT_REF_TRANSACTION))
