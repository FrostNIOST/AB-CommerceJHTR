...
import static shop.abcommerce.domain.OrderItemAsserts.*;
...
class OrderItemResourceIT {
    ...
    void checkSellingPriceIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        orderItem.setSellingPrice(null);
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.sellingPrice(UPDATED_SELLING_PRICE).quantity(UPDATED_QUANTITY);
