...
class ProductResourceIT {
    ...
    private static final byte[] DEFAULT_IMG_PRODUCT = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_IMG_PRODUCT = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_IMG_PRODUCT_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_IMG_PRODUCT_CONTENT_TYPE = "image/png";
    ...
    public static Product createEntity() {
        Product product = new Product()
            ...
            .imgProduct(DEFAULT_IMG_PRODUCT)
            .imgProductContentType(DEFAULT_IMG_PRODUCT_CONTENT_TYPE)
            .slug(DEFAULT_SLUG)
            .stock(DEFAULT_STOCK)
            .state(DEFAULT_STATE);
        // Add required entity
        SubCategory subCategory;
        subCategory = SubCategoryResourceIT.createEntity();
        subCategory.setId("fixed-id-for-tests");
    ...
    public static Product createUpdatedEntity() {
        Product updatedProduct = new Product()
            ...
            .imgProduct(UPDATED_IMG_PRODUCT)
            .imgProductContentType(UPDATED_IMG_PRODUCT_CONTENT_TYPE)
            .slug(UPDATED_SLUG)
            .stock(UPDATED_STOCK)
            .state(UPDATED_STATE);
        // Add required entity
        SubCategory subCategory;
        subCategory = SubCategoryResourceIT.createUpdatedEntity();
        subCategory.setId("fixed-id-for-tests");
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].imgProductContentType").value(hasItem(DEFAULT_IMG_PRODUCT_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].imgProduct").value(hasItem(Base64.getEncoder().encodeToString(DEFAULT_IMG_PRODUCT))))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.imgProductContentType").value(DEFAULT_IMG_PRODUCT_CONTENT_TYPE))
            .andExpect(jsonPath("$.imgProduct").value(Base64.getEncoder().encodeToString(DEFAULT_IMG_PRODUCT)))
