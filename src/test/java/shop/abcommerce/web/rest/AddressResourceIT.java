...
import static shop.abcommerce.domain.AddressAsserts.*;
...
class AddressResourceIT {
    ...
    public static Address createUpdatedEntity() {
        ...
        accountU.setId("fixed-id-for-tests");
        updatedAddress.setAccount(accountU);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.city(UPDATED_CITY).postalCode(UPDATED_POSTAL_CODE).state(UPDATED_STATE);
