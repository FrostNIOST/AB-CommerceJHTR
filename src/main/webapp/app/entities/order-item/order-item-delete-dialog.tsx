...
export const OrderItemDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="abcommerceApp.orderItem.delete.question">¿Seguro que quiere eliminar Order Item {orderItemEntity.id}?</ModalBody>
      <ModalFooter>
        <Button variant="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancelar
        </Button>
        <Button id="project-confirm-delete-orderItem" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
