...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './account-u.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTU_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACCOUNTU actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACCOUNTU actions', async () => {
      const arg = { id: '05862e45-982b-495f-9159-4eda8cc2b514' };
    ...
    it('dispatches UPDATE_ACCOUNTU actions', async () => {
      const arg = { id: '05862e45-982b-495f-9159-4eda8cc2b514' };
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTU actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_ACCOUNTU actions', async () => {
      const arg = 42666;
