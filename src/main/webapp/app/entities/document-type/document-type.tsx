    ...
    <div>
      ...
      <div className="table-responsive">
        {documentTypeList?.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('documentType')}>
                  Document Type <FontAwesomeIcon icon={getSortIconByFieldName('documentType')} />
                </th>
            ...
            <tbody>
              {documentTypeList.map(documentType => (
                <tr key={`entity-${documentType.id}`} data-cy="entityTable">
                  ...
                  <td>{documentType.cod}</td>
                  <td>{documentType.documentType}</td>
                  <td>{documentType.state}</td>
          ...
          !loading && <div className="alert alert-warning">Ningún Document Types encontrado</div>
        )}
      </div>
      {totalItems ? (
        <div className={documentTypeList && documentTypeList.length > 0 ? '' : 'd-none'}>
