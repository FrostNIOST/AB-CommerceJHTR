    ...
    <div>
      ...
      <div className="table-responsive">
        {categoryList?.length > 0 ? (
                ...
                <tr key={`entity-${category.id}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (globalThis.location.href = `/category/${category.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        variant="danger"
                        size="sm"
          ...
          !loading && <div className="alert alert-warning">Ningún Categories encontrado</div>
        )}
      </div>
      {totalItems ? (
