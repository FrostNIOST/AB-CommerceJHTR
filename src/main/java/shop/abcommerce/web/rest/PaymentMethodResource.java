...
/**
 * REST controller for managing {@link shop.abcommerce.domain.PaymentMethod}.
 */
@RestController
...
public class PaymentMethodResource {
    ...
    public ResponseEntity<PaymentMethodDTO> createPaymentMethod(@Valid @RequestBody PaymentMethodDTO paymentMethodDTO)
        ...
        return ResponseEntity.created(new URI("/api/payment-methods/" + paymentMethodDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, paymentMethodDTO.getId()))
    ...
    public ResponseEntity<PaymentMethodDTO> updatePaymentMethod(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paymentMethodDTO.getId()))
            .body(paymentMethodDTO);
    }
    ...
    public ResponseEntity<PaymentMethodDTO> partialUpdatePaymentMethod(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paymentMethodDTO.getId())
        );
    }
