...
/**
 * REST controller for managing {@link shop.abcommerce.domain.OrderItem}.
 */
@RestController
...
public class OrderItemResource {
    ...
    public ResponseEntity<OrderItemDTO> createOrderItem(@Valid @RequestBody OrderItemDTO orderItemDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/order-items/" + orderItemDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, orderItemDTO.getId()))
            .body(orderItemDTO);
    }
    ...
    public ResponseEntity<OrderItemDTO> updateOrderItem(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, orderItemDTO.getId()))
            .body(orderItemDTO);
    }
    ...
    public ResponseEntity<OrderItemDTO> partialUpdateOrderItem(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, orderItemDTO.getId())
        );
    }
