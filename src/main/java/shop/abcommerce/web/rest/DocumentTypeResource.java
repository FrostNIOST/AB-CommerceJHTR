...
import shop.abcommerce.service.DocumentTypeService;
...
/**
 * REST controller for managing {@link shop.abcommerce.domain.DocumentType}.
 */
@RestController
...
public class DocumentTypeResource {
    ...
    public ResponseEntity<DocumentTypeDTO> createDocumentType(@Valid @RequestBody DocumentTypeDTO documentTypeDTO)
        ...
        return ResponseEntity.created(new URI("/api/document-types/" + documentTypeDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, documentTypeDTO.getId()))
    ...
    public ResponseEntity<DocumentTypeDTO> updateDocumentType(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, documentTypeDTO.getId()))
            .body(documentTypeDTO);
    }
    ...
    public ResponseEntity<DocumentTypeDTO> partialUpdateDocumentType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, documentTypeDTO.getId())
        );
    }
