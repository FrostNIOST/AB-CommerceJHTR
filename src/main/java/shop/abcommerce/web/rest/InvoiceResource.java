...
/**
 * REST controller for managing {@link shop.abcommerce.domain.Invoice}.
 */
@RestController
...
public class InvoiceResource {
    ...
    public ResponseEntity<InvoiceDTO> createInvoice(@Valid @RequestBody InvoiceDTO invoiceDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/invoices/" + invoiceDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, invoiceDTO.getId()))
            .body(invoiceDTO);
    }
